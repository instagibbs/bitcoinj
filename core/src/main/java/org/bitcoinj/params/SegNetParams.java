...
public class SegNetParams extends AbstractBitcoinNetParams {
    public SegNetParams() {
        ...
        p2shHeader = 196;
        p2wpkh = 3;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader, p2wpkh };
        dumpedPrivateKeyHeader = 239;
        genesisBlock.setTime(1296688602L); //TODO
        genesisBlock.setDifficultyTarget(0x1d00ffffL); //TODO
        genesisBlock.setNonce(414098458); //TODO
        spendableCoinbaseDepth = 100;
        subsidyDecreaseBlockCount = 210000;
        String genesisHash = "0d5b9c518ddf053fcac71730830df4526a9949c08f34acf6a1d30464d22f02aa";//genesisBlock.getHashAsString();
        //checkState(genesisHash.equals("000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943")); //TODO
